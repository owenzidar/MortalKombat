...
class Conan : public Character{
	...
	private:
		SDL_Rect standRight[10]; //Sprite clippings for standing facing right
		SDL_Rect standLeft[10]; //Sprite clippings for standing facing left
		...
		SDL_Rect deadRight[8]; //Sprite clippings for dying facing right
...
//Display the dot
void Conan::show(SDL_Surface* destination){
